...
export function managedPrSnapshot(root, prNumber) {
  return runJson('gh', [
    ...
    'number,url,state,isDraft,isCrossRepository,headRefOid,headRefName,headRepository,baseRefName,mergedAt,closedAt,labels,reviewDecision,comments,reviews,statusCheckRollup,body,closingIssuesReferences',
  ], { cwd: root, allowFailure: true });
}
